...
public class FilePageSecurityTestManager {
    ...
    public void loginTest() {
        ...
        //Enter email
        filePage.emailInputField.sendKeys("manager1@secme.com");
        ...
        assertEquals(filePage.userAuthenticationSuccessMessage.getText(), "Manager U1");
    }

    @Severity(SeverityLevel.CRITICAL)
    @Description("Check file upload error message")
    @Story("Test verify the response of the file upload success message")
    @Test(priority = 1, testName = "Should be able to upload file")
    ...
    @Test(priority = 2, testName = "Should be able to view files")
